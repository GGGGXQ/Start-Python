...
class SendMoreMoney2(Chromosome):
    ...
    def crossover(self, other: 'SendMoreMoney2') -> Tuple['SendMoreMoney2', 'SendMoreMoney2']:
        ...
        idx1, idx2 = sample(range(len(child1.letters)), 2)
    ...
    def mutate(self) -> None:
        idx1, idx2 = sample(range(len(self.letters)), 2)
...
if __name__ == "__main__":
    ...
    ga: GeneticAlgorithm[SendMoreMoney2] = GeneticAlgorithm(initial_population, threshold=1.0, max_generations=1000,
